...
<?php
    if (isset($_POST['terima'])){
        ...
        include "../koneksi.php";
        $sql = mysqli_query($konn,"update transaksi set status = 'produk telah diterima' WHERE id_transaksi ='$id_transaksi' ");
        if ($sql) { 
            echo "<script>location.href='data_transaksi.php'</script>";
        }
    }

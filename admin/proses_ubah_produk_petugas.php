<?php
 ...
 mysqli_error($konn);
            if ($input) {
                 echo "<script>alert('Berhasil merubah produk');location.href='tampil_produk_petugas.php';</script>";
            }
            else {
                echo "<script>alert('Gagal merubah produk');location.href='tampil_produk_petugas.php';</script>";
            }
        }
    }
    else{

    ...
    if(empty($nama)){
        ...
        // if everything is ok, try to upload file
            ...
            if (move_uploaded_file($_FILES["foto"]["tmp_name"], $target_file)) {
                ...
                if($insert) {
                    echo "<script>alert('Sukses menambahkan produk');location.href='tampil_produk_admin.php';</script>";
                } else {
                    echo "<script>alert('Gagal menambahkan produk');location.href='tampil_produk_admin.php';</script>";
                }
            } else {
                echo "<script>alert('Error saat upload file foto');location.href='tampil_produk_admin.php';</script>";
            }
        }

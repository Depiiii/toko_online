...
<body>
    ...
    <tbody>
        ...
        <a href="hapus_produk.php?id_produk=<?=$data_produk['id_produk'] ?>" onclick="return confirm('Are you sure you want to delete this item?') "class="btn btn-danger">Hapus</a>
        </td>
        </tr>
        <?php
        }
    ...
    <a href="tambah_produk.php" class="btn btn-primary" style="float: right; width: 150px;">Tambah Produk</a>

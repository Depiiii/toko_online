            ...
            <h3> Ubah Petugas</h3>
                ...
                if(empty($nama_petugas)){
                    ...
                    if(empty($password)){
                        ...
                        $update=mysqli_query($konn,"update petugas set nama_petugas='".$nama_petugas."', username='".$username."' where id_petugas = '".$id_petugas."' ") or die(mysqli_error($konn));

                        if($update){

                            echo "<script>alert('Sukses update petugas');location.href='tampil_petugas_admin.php';</script>";
                        ...
                        $update=mysqli_query($konn,"update petugas set nama_petugas='".$nama_petugas."',username='".$username."', password='".md5($password)."'where id_petugas = '".$id_petugas."'") or die(mysqli_error($konn));
